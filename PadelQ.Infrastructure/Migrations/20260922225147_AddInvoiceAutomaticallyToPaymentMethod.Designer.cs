...
namespace PadelQ.Infrastructure.Migrations
{
    ...
    [Migration("20260922225147_AddInvoiceAutomaticallyToPaymentMethod")]
    partial class AddInvoiceAutomaticallyToPaymentMethod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.ArcaSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CertificateCrtPem")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("WsaaExpiration")
                        .HasColumnType("datetime2");

                    b.Property<string>("WsaaSign")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("WsaaToken")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("ArcaSettings");
                });
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.BookingConsumption", b =>
                {
                    ...
                    b.Property<int>("Fractions")
                        .HasColumnType("int");

                    b.Property<bool>("IsComboRedeemed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.CashClosure", b =>
                {
                    ...
                    b.Property<string>("ActualTotals")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.Ingredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.KitchenOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.KitchenOrderItem", b =>
                {
                    ...
                    b.Property<Guid>("BookingConsumptionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BookingConsumptionId");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.PaymentMethod", b =>
                {
                    ...
                    b.Property<bool>("InvoiceAutomatically")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.PointTerminal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<bool>("IsDoubleUnitCombo")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.RecipeIngredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.ClubActivity", b =>
                {
                    b.HasOne("PadelQ.Domain.Entities.ApplicationUser", "Instructor")
                        .WithMany()
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.KitchenOrderItem", b =>
                {
                    b.HasOne("PadelQ.Domain.Entities.BookingConsumption", "BookingConsumption")
                        .WithMany()
                        .HasForeignKey("BookingConsumptionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("BookingConsumption");
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.Product", b =>
                {
                    b.HasOne("PadelQ.Domain.Entities.Recipe", "Recipe")
                        .WithMany()
            ...
            modelBuilder.Entity("PadelQ.Domain.Entities.RecipeIngredient", b =>
                {
                    b.HasOne("PadelQ.Domain.Entities.Ingredient", "Ingredient")
                        .WithMany()
