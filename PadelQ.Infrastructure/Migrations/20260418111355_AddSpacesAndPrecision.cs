...
{
    /// <inheritdoc />
    public partial class AddSpacesAndPrecision : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpaceBookings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SpaceBookings_Spaces_SpaceId",
                        column: x => x.SpaceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpaceBookings_SpaceId",
                table: "SpaceBookings",
                column: "SpaceId");

            migrationBuilder.CreateIndex(
                name: "IX_SpaceBookings_UserId",
                table: "SpaceBookings",
                column: "UserId");
        }
