...
namespace PadelQ.Application.Common.Interfaces
{
    ...
    {
        Task<(bool Succeeded, string UserId)> CreateUserAsync(string userName, string email, string password, string fullName, string? dni, string? phoneNumber, string? role = "User", string? cuit = null, string? ivaCondition = null);
        ...
        Task<(bool Succeeded, string Message)> UpdateUserAsync(string userId, string fullName, string email, string? phoneNumber, bool isActive, string? dni, string? address, string? city, string? province, string? photoUrl, string? role, bool canAccessActivities, bool canAccessBookings, string? cuit = null, string? ivaCondition = null);
